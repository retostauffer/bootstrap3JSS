...
<div class="pkp_helpers_clear">
	{fbvFormSection for="title" title="common.prefix" inline="true" class="jss_theme_hide_element" size=$fbvStyles.size.SMALL}
	...
	{fbvFormSection for="title" title="common.title" class="jss_submission_step3_title" inline="true" size=$fbvStyles.size.LARGE required=true}
		{fbvElement type="text" multilingual=true name="title" id="title" value=$title readonly=$readOnly maxlength="255" required=true}
	{/fbvFormSection}
</div>
{fbvFormSection title="common.subtitle" for="subtitle" class="jss_theme_hide_element"}
