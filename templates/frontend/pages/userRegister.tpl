...
<div id="main-content" class="page page_register">
	...
	All publications and additional material can be accessed by anyone,
	no login required. There are three reasons which require an active
	...
	<div class="registration_content">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-10 col-lg-11">
				<strong>Receive email Notifications</strong><br />

				When you want to receive email notifications
				about new volumes and announcements.
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-2 col-lg-1">
			...
			<div class="col-xs-12 col-sm-10 col-lg-11">
				<strong>Submitting Articles</strong><br />

				In case you would like to submit a manuscript.
				At least the corresponding author must be registered.
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-2 col-lg-1">
			...
			<div class="col-xs-12 col-sm-10 col-lg-11">
				<strong>Acting as a Reviewer</strong><br />

				When you want to act as a reviewer. You can specify review interests 
				which our section editors can access to find suitable reviewers
